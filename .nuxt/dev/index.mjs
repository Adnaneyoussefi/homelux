...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"name":"description","content":"Discover premium home appliances, kitchen essentials, and artisanal decor products."}],"link":[{"rel":"icon","type":"image/x-icon","href":"/favicon.ico"},{"rel":"stylesheet","href":"https://fonts.googleapis.com/css2?family=Playfair+Display:wght@400;500;600;700;800&family=Work+Sans:wght@300;400;500;600&display=swap"}],"style":[],"script":[],"noscript":[],"title":"HomeLux - Premium Home & Kitchen Essentials"};
...
const _lazy_n6CNB4 = () => Promise.resolve().then(function () { return categories_get$1; });
const _lazy_lLuL8R = () => Promise.resolve().then(function () { return data; });
const _lazy_P9DtEF = () => Promise.resolve().then(function () { return products_get$1; });
const _lazy_qPzIv1 = () => Promise.resolve().then(function () { return _slug__get$1; });
...
const handlers = [
  ...
  { route: '/api/categories', handler: _lazy_n6CNB4, lazy: true, middleware: false, method: "get" },
  { route: '/api/mock/data', handler: _lazy_lLuL8R, lazy: true, middleware: false, method: undefined },
  { route: '/api/products', handler: _lazy_P9DtEF, lazy: true, middleware: false, method: "get" },
  { route: '/api/products/:slug', handler: _lazy_qPzIv1, lazy: true, middleware: false, method: "get" },
...
const categories_get = defineEventHandler(() => {
  return categories;
});
...
const products_get = defineEventHandler((event) => {
  ...
  if (query.search) {
    ...
    filteredProducts = filteredProducts.filter(
      (p) => p.name.toLowerCase().includes(searchLower) || p.description.toLowerCase().includes(searchLower) || p.tags.some((tag) => tag.toLowerCase().includes(searchLower))
    );
  }
  if (query.sort) {
    switch (query.sort) {
